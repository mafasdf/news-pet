...
We also set up a testing option where a number of categories are artificially grouped together as a ``trash'' category, to simulate typical use of our system.
