...
public class RSSRetrievalJob implements Runnable
{
	 ...
	 */
	private Collection<FeedChannelPair> resultStorage;
	 ...
	 * Feed to read from.
	 */
	public RSSRetrievalJob(Collection<FeedChannelPair> resultStorage, Feed feed)
	{
	...
	public void run()
	{
		...
		FeedChannelPair toAdd = new FeedChannelPair(feed, channel);
