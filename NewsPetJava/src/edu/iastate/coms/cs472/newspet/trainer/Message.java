...
{	
	...
	public Message(String rawMessage)
	{
		...
		if(elements.length!=4)
			throw new IllegalArgumentException("String must have 4 comma-delimited values");
		
		if(elements[0].equals("INCREMENTAL"))
			this.messageType=MessageType.INCREMENTAL;
		else if (elements[0].equals("BATCH"))
			this.messageType=MessageType.BATCH;
		else
			throw new IllegalArgumentException("First element must be INCREMENTAL or BATCH");
